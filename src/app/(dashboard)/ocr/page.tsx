...
export default function OCRPage() {
    ...
    return (
        <div className="page-container" style={{ padding: isMobile ? '16px 20px' : '32px 40px', maxWidth: 1000 }}>
            ...
            <div className="page-container" style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: 24 }}>
                ...
                <div>
                    <div
                        ...
                        <div className="page-container" style={{ fontSize: 48, marginBottom: 16 }}>📸</div>
                    ...
                    <div className="page-container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        {extractedText && (
                            <div className="page-container" style={{ display: 'flex', gap: 8 }}>
                                ...
                                <button onClick={() => setExtractedText('')} className="btn-ghost" style={{ fontSize: 12 }}>🗑️ Clear</button>
                            </div>
                        )}
                    </div>
                    <textarea
